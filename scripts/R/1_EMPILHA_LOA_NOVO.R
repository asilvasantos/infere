...
LOA_2022 <- LOA_2022 %>% select(-`Dota√ß√£o Inicial CN`)

## -- -- -- -- -- -- -- - --- - - -- - -
## RENOMIA PARA MANTER O PADRAO DE NOME
names(LOA_2022)[20] <- "DotaÁ„o Inicial"


## E CONSEQUENTEMENTE RENOMEIA OS ANOS DE 2015 A 2021 PARA TAMBEM MANTER O PADRAO
names(LOA_2015)[20] <- "DotaÔøΩÔøΩo Inicial"
names(LOA_2016)[20] <- "DotaÔøΩÔøΩo Inicial"
names(LOA_2017)[20] <- "DotaÔøΩÔøΩo Inicial"
names(LOA_2018)[20] <- "DotaÔøΩÔøΩo Inicial"
names(LOA_2019)[20] <- "DotaÔøΩÔøΩo Inicial"
names(LOA_2020)[20] <- "DotaÔøΩÔøΩo Inicial"
names(LOA_2021)[20] <- "DotaÔøΩÔøΩo Inicial"
## -- -- -- -- -- -- -- - --- - - -- - -
...
names(LOA_2002_A_2014)[20] <- "DotaÔøΩÔøΩo Inicial"
