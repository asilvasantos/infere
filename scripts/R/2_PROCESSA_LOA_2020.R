...
LOA_FINAL_GND_4 <- read_excel('LOA2020.xlsx')
...
LOA_FINAL_GND_4 <- separate(LOA_FINAL_GND_4, col = 'Ação (Cod/Desc)  (Ajustada)', into = c('ACAO_CODIGO', 'ACAO_DESCRICAO'), sep = "-")

head(LOA_FINAL_GND_4)



# Exemplo: Separar a coluna 'nome_completo' em 'nome' e 'sobrenome'
dados <- data.frame(
  nome_completo = c("João Silva", "Maria Souza", "Pedro Oliveira"),
  stringsAsFactors = FALSE
)

dados_separados <- separate(dados, col = nome_completo, into = c("nome", "sobrenome"), sep = " ")
...
LOA_FINAL_GND_4$UFis <- NA
LOA_FINAL_GND_4$UFis <- LOA_FINAL_GND_4$Estado

str_detect(LOA_FINAL_GND_4$'SUBTITULO_DESCRICAO','OBTENÇÃO DE MEIOS DA MARINHA')
str_detect(LOA_FINAL_GND_4$'ACAO_DESCRICAO',"TECNOLOGIA NUCLEAR DA MARINHA")


LOA_FINAL_GND_4$UFis <- ifelse(str_detect(LOA_FINAL_GND_4$'SUBTITULO_DESCRICAO',"OBTENÇÃO DE MEIOS DA MARINHA"),"EX",LOA_FINAL_GND_4$UFis)
...
LOA_FINAL_GND_4$UFis <- ifelse(str_detect(LOA_FINAL_GND_4$`A??o (Cod/Desc)  (Ajustada)`, "RIO SÃO FRANCISCO") &
        !(LOA_FINAL_GND_4$UFis %in% c("SE", "BA", "CE", "PB", "PE", "PI", "RN", "NE")), "NE", LOA_FINAL_GND_4$UFis)
...
LOA_FINAL_GND_4$UFis <- ifelse(str_detect(LOA_FINAL_GND_4$`Subt?tulo (Cod/Desc)`, "EXTERIOR") & LOA_FINAL_GND_4$UFis == "ND",
    "EX", LOA_FINAL_GND_4$UFis)



LOA_FINAL_GND_4$UFis <- ifelse(str_detect(LOA_FINAL_GND_4$Regi?o, "NORDESTE") & LOA_FINAL_GND_4$UFis=="ND","NE",LOA_FINAL_GND_4$UFis) 
LOA_FINAL_GND_4$UFis <- ifelse(str_detect(LOA_FINAL_GND_4$Regi?o, "SUL")      & LOA_FINAL_GND_4$UFis=="ND","SL",LOA_FINAL_GND_4$UFis) 
LOA_FINAL_GND_4$UFis <- ifelse(str_detect(LOA_FINAL_GND_4$Regi?o, "NORTE")    & LOA_FINAL_GND_4$UFis=="ND","NO",LOA_FINAL_GND_4$UFis) 
LOA_FINAL_GND_4$UFis <- ifelse(str_detect(LOA_FINAL_GND_4$Regi?o, "SUDESTE")  & LOA_FINAL_GND_4$UFis=="ND","SD",LOA_FINAL_GND_4$UFis) 
...
LOA_FINAL_GND_4 <- LOA_FINAL_GND_4 %>%
    mutate(UF_nova = ifelse(`Subtítulo (Cod/Desc)` == "NACIONAL", NA, UF_nova),
           ...
           Reg_nova = ifelse(Região != "Nacional" | Regi?o != "NÃO INFORMADO" |
                               is.na(Região),
                             Região,Reg_nova),
...
##    Salva Arquivo
##- -- -- -- -- -- -- -- --
write.csv(LOA_FINAL_GND_4, "LOA2020_Amostra.csv")
...
# ACAO_AJUSTADA_TESTE <- data_frame(unique(LOA_FINAL_GND_4$`A??o (Cod/Desc)  (Ajustada)`))
# SUBTITULO_AJUSTADA_TESTE <- data_frame(unique(LOA_FINAL_GND_4$`Subt?tulo (Cod/Desc)`))
